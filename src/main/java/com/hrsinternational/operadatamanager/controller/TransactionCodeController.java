...
public class TransactionCodeController implements TransactionCodeApiSpec {
    ...
    public ResponseEntity<Void> createTransactionCode(
            @Valid @RequestBody TransactionCodeDto transactionCodeDto
    ) {

        transactionCodeService.create(transactionCodeDto);
