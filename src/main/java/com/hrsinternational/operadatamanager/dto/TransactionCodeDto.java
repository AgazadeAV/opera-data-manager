...
public class TransactionCodeDto {
    ...
    @Pattern(regexp = "^(Lodging|Food and Beverage|Telephone|Minibar|Other Revenue|Tax|Non-Revenue)?$", message = "Transaction Type error. Available options are Lodging, Food and Beverage, Telephone, Minibar, Other Revenue, Tax, Non-Revenue or blank.")
